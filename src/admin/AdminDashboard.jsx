...
function AdminDashboard() {
  ...
  const fetchOrders = async () => {
    setLoading(true);
    try {
      const res = await fetch("https://api.dastrkhwan.site/orders/get_all_orders.php");
...
const handleStatusChange = async (orderId, newStatus) => {
    try {
      const res = await fetch("https://api.dastrkhwan.site/orders/update_order_status.php", {
        method: "POST",
  ...
  const handleVerifyPayment = async (orderId) => {
    try {
        const res = await fetch("https://api.dastrkhwan.site/auth/verify_payment.php", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
